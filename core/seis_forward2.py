        ...
        for i_source in range(N_source_to_do):     
            ...
            if graph==0:
                ...
                for it in range(0, nt):
                   ...
                   # val1 = copy.deepcopy( lapg_store_flat[nx*nz*it:nx*nz*(it+1)])
                    
                   # print(kgs.rms(val1- lapg_store_flat[nx*nz*it:nx*nz*(it+1)]))
            ...
            if do_diff:                
                ...
                profile('prep for time loop diff')
